...
<body>
            ...
            <nav aria-label="...">
                <ul class="pagination">
                    ...
                    <li class="page-item active" aria-current="page">
                        <a class="page-link" href="catalogo.php">1</a>
                    </li>
                    <li class="page-item"><a class="page-link" href="catalogo_pag_2.php">2</a></li>
                    <li class="page-item"><a class="page-link" href="catalogo_pag_3.php">3</a></li>
                    <li class="page-item">
                        <a class="page-link" href="catalogo_pag_2.php">Next</a>
                    </li>
                </ul>
            </nav>
        </div>
    ...
    <script>
        const mp = new MercadoPago('TEST-68be139f-bd6e-40a8-a4e4-bb94b07eba76', {
            locale: 'es-MX'
        });
