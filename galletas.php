...
?>
	...
	<header id="ofertas-cupcakes" class="vh-40">
		<img src="img/Categorias/Banner/2.png">
	</header>
	<!-- FINAL ofertas-->
	...
	<section id="catalogo" class="py-5">
		...
		<div class="products-preview">
			...
			<div class="preview" data-target="p1">
				...
				<img src="<?php echo htmlspecialchars($producto['ImagenProducto']); ?>">
				<h3 class="text-none mt-3 mb-1"><?php echo htmlspecialchars($producto['NombreProd']); ?> <?php echo htmlspecialchars($producto['NombreSabor']); ?></h3>
				<div class="estrellas">
				...
				<p>Torta, pequeña, de harina, manteca y azúcar, acompañada de nuez moscada..</p>
				<div class="precio">$<?php echo htmlspecialchars($producto['Precio']); ?></div>
				<div class="botones">
					<a href="#" class="carritoP">Comprar</a>
				</div>
			</div>
			<!------------------------ -->
	...
	<section id="suscribete" class="py-5">
		<form id="suscrito" action="#suscrito" class="container" method="POST">
			<div class="d-flex flex-column align-items-center justify-content-center">
				...
				<div class="input-group mb-3 mt-3">
					<input type="text" class="form-control" name="email" placeholder="Ingresa tu correo ..." required value="<?php echo $userEmail ?>">
					<input class="btn btn-primary" type="submit" name="subscribe" value="Comenzar">
				</div>
			</div>
		</form>
	</section>
